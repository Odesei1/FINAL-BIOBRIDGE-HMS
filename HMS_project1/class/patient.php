...
class Patient {
    ...
    public function viewAll() {
        $sql = "SELECT pat_id, pat_first_name, pat_middle_init, pat_last_name, pat_dob, pat_gender, pat_contact_num, pat_email, pat_address
         FROM {$this->table} ORDER BY pat_created_at DESC";
        $stmt = $this->conn->prepare($sql);
        $stmt->execute();
        return $stmt->fetchAll(PDO::FETCH_ASSOC);
    }
